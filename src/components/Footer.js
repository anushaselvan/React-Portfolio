...
function Footer() {
    return (
      <div className="Footer">
        <a href="https://github.com/anushaselvan" target="_blank" rel="noreferrer" > 
            <img src ={require("../components/assets/icons8-github-48.png")} alt="gitHub logo"/></a>

        <a href="https://www.linkedin.com/in/anusha-s-89734421b/" target="_blank" rel="noreferrer" >
            <img src ={require('../components/assets/icons8-linkedin-48.png')} alt="linkedIn logo"/></a>
   
        <a href="mailto:anushaselvan@gmail.com?" target="_blank" rel="noreferrer" >
